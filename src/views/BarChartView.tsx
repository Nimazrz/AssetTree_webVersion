...
export const BarChartView: React.FC<BarChartProps> = ({
  ...
  return (
    <div className="w-full pb-16 flex flex-col">
      {/* Control Toolbar */}
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs text-xs sm:text-sm">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-medium text-xs cursor-pointer"
        >
      ...
      {/* Bars Container */}
      <div className="w-full bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col gap-4">
        {items.length === 0 ? (
          ...
          items.map((node) => {
            ...
            return (
              <div
                ...
                className="flex flex-col gap-1.5 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer transition-colors"
              >
                <div className="flex items-center justify-between gap-2 text-xs sm:text-sm">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 min-w-10 text-left">
